                    ...
                    (r = f),
                      ...
                      (Array.isArray(a)
                        ? ((i = r),
                          ...
                          (c = o[1]),
                          (d = s.toString().length),
                          (u = parseInt(i.substr(0, d))),
                          s <= u && u <= c)
                        : ((t = r),
                          (n = a) instanceof RegExp
                            ? n.test(t)
                            : ((n = n.toString()),
          ...
          function (e, t, n) {
            ...
            Object.defineProperty(n, "__esModule", { value: !0 }),
              (n.default = [
                ...
                { name: "amex", pattern: [34, 37] },
                { name: "diners", pattern: [36, 309, [300, 305], [38, 39]] },
  ...
  function (e, t, n) {
    ...
    var r = (function () {
        function t() {
          ...
          (this.cardNumber = e("#numero-do-cartao-front")),
            (this.cardNumberBack = e("#numero-do-cartao-back")),
            (this.cardName = e("#nome-front")),
            (this.cardNameBack = e("#nome-back")),
            (this.cardDate = e("#data-front")),
            (this.cardDateBack = e("#data-back")),
            (this.cardBack = e("#cartao-back")),
            (this.areaTitle = e("#titulo-area")),
            (this.cardAreaTitle = e("#card-area-titulo")),
            (this.areaButton = e("#button-area")),
            (this.flipper = e("#flipper")),
            (this.littleMachine = e("#maquininha")),
            (this.niceEdge = e("#bordinha-nice")),
            (this.successFeedback = e("#feedback-sucesso")),
            (this.total = e("#total")),
            (this.willDisappearAll = document.querySelectorAll(".vai-sumir")),
            (this.willDisappear = e(".vai-sumir")),
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                this.littleMachine.addEventListener(
                  "transitionend",
                  function () {
                  ...
                  this.flipper.addEventListener("animationend", function () {
                    e.successFeedback.style.cssText =
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (this.littleMachine.style.height = "".concat(
                  this.littleMachine.offsetHeight,
                  "px"
                )),
                  this.scrolTop(),
                  this.cardNumberBack.insertAdjacentHTML(
                    "afterbegin",
                  ...
                  this.cardDateBack.insertAdjacentHTML(
                    "afterbegin",
                    this.cardDate.value
                  ),
                  ...
                  this.cardBack.addEventListener(
                    ...
                    function () {
                      e.willDisappearAll.forEach(function (e) {
                        ...
                        e.willDisappear.addEventListener(
                          "animationend",
                          function () {
                            e.willDisappearAll.forEach(function (e) {
                              return e.remove();
                            }),
                              (e.total.style.cssText =
                                "padding:15px; border:2px solid rgba(255,255,255,0.7); border-radius:4px;"),
                              (e.littleMachine.style.height = "100px"),
                              e.secondStep();
                          },
                          !1
                        );
    ...
    var l = (function () {
          ...
          (n = [
            {
              ...
              value: function (e) {
                ...
                t.length <= 3
                  ? this.remove()
                  : Object(d.cardType)(t) && this.add(t);
              },
            },
            {
              key: "add",
              value: function (e) {
                var t = this,
                  ...
                  r = this.countChars(n);
                this.cardFlag.setAttribute(
                  "alt",
                  "Logo cartão de crédito " + n
                ),
                  this.cardFlag.setAttribute(
                    "src",
                    "dist/img/flags/" + n + ".png"
                  ),
                  this.cardNumber.setAttribute("minlength", r.minlength + 3),
                  this.cardNumber.setAttribute("maxlength", r.maxlength + 3),
                  window.setTimeout(function () {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.cardFlag.classList.remove("marca-cartao-entra"),
                  window.setTimeout(function () {
                    e.cardFlag.setAttribute("src", "dist/img/flags/visa.png"),
                      e.cardFlag.setAttribute("alt", ""),
                      e.cardNumber.removeAttribute("minlength"),
                      e.cardNumber.setAttribute("maxlength", 22);
                  }, 100);
              },
            },
            {
              ...
              value: function (e) {
                ...
                return { minlength: t, maxlength: n };
              },
            },
          ]) && u(e.prototype, n),
          r && u(e, r),
      ...
      f = function () {
        var e = new l();
        document
          .getElementById("numero-do-cartao-front")
          .addEventListener("keyup", e.init);
      };
    o(), c(), f();
    n(1);
    function h() {
