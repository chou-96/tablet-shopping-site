                    ...
                    <div class=img_checkbox>
                        ...
                        <div id="quantity_sel">
                            <div style="display:none">
                                <select name="p_name">
                                    <option value="tab s8+"selected>Galaxy Tab S8+</option>
                                </select>
                                <select name="p_brand">
    ...
    <div id="myContainer">
        ...
        <div class="ms-left">
            ...
            <div class="ms-section" id="left2">
                ...
                <div>
                    <div>
                        <div class="ga8plus_left2">
                            <img class="ga8plus_left2_img1" src="img/s8+/s8+_02.png" alt="">
                            <h5>S Pen同梱</h5>
                            <span>超低遅延を実現し、書き心地はまるで紙のよう イラスト制作。<br>資料へのメモ書きなどあらゆるシーンで想いのままに利用可能。</span>
                            <h5>Galaxyデバイス連携機能</h5>
                            <span>自動テザリング、クリップボードシェア、ファイルのクイック共有など、もっと便利に利用できるGalaxy連携機能を搭載</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ms-section" id="left3">
                ...
                <div data-aos="flip-left">Galaxy Tab S8 Ultra</div>
        ...
        <div class="ms-right">
            <div class="ms-section ga8plus_right1" id="right1">
                <img class="ga8plus_pen" src="img/s8+/pen.png" alt="">
                <div class="ga8plus_right1_words">
                    <h1>Galaxy Tab S8+</h1>
                    <P>
                        GalaxyタブレットTab S8シリーズは、大容量バッテリーとGalaxy史上最速チップを搭載しゲーミングに最適。
                    </P>
                </div>
            </div>

            <div class="ms-section ga8plus_right2" id="right2">
                    <div>
                        <img src="img/s8+/s8+_03.png" alt="">
                    </div>
                    <div>
                        <h5>大容量バッテリー搭載</h5>
                        <span>長時間利用が可能なだけでなく、<br>最大45Wの超急速充電対応で短時間でのフル充電が可能。</span>
                    </div>
            </div>
