        ...
        <main>
            <div class="top_bk_color">
                ...
                <div class="main_product">
                    <div>
                        <img class="main_product_img" src="img/ipad10/ipad10_06.jpg" alt="">
                    </div>
                    ...
                    <div id="overlay">
                        <form action="order_check.php" method="post" id="modal">
                            ...
                            <div class=img_checkbox>
                                <img src="img/ipad10/ipad10_07.jpg" alt="">
                                <div id="quantity_sel">
                                    <div style="display:none">
                                        <select name="p_name">
                                            <option value="ipad 10"selected>iPad 10</option>
                                        </select>
                                        <select name="p_brand">
                    ...
                    <!-- <h2>About</h2> -->
                        <div class="ipad ipad_1">
                            <div class="ipad_words object">
                                <h1>絵を描いたり、色を塗ったり、文字を書きたい時は、Apple Pencilで。タイピングしたり、トラックパッドで作業したり、映画鑑賞や読書を楽しみたい時は、Magic Keyboard Folioでどうぞ2。2つのパーツに分かれるフレキシブルなデザインで、おなじみのキーボードショートカットも、どこでもクリックできるトラックパッドも、驚くほど快適なキーボードも使えます。</h1>
                            </div>
                            <div class="ipad_img object">
                                <img src="img/ipad10/ipad10_10.png" alt=""> 
                            </div>
                        </div>
                        <div class="ipad ipad_2">
                            <div class="ipad_img_even object">
                                <img src="img/ipad10/ipad10_11.png" alt=""> 
                            </div>
                            <div class="ipad_words_even object">
                                <h1>iPadの体験すべてがスムーズかつ簡単に感じるのは、iPadOSがすべてを連係させているから。お気に入りのアプリを横に並べて使ったり、写真を編集して共有したり、自分のあらゆるファイルにアクセスできるようにします。</h1>
                            </div>
                        </div>
                        <div class="ipad ipad_3">
                            <div class="ipad_words object">
                                <h1>A14 Bionicチップは、どんなアクティビティでもパワーとパフォーマンスを発揮します。iMovieで4Kビデオを編集する。友だちと旅行を計画する。グラフィックスを駆使したゲームをプレイする。すべてをぶっ続けで楽しめるように、iPadは一日中使えるバッテリーも搭載しています3。</h1>
                            </div>
                            <div class="ipad_img object">
                                <img src="img/ipad10/ipad10_12.png" alt=""> 
                            </div>
                        </div>
                        <div class="ipad ipad_4">
                            <div class="ipad_img_even object">
                                <img src="img/ipad10/ipad10_13.png" alt=""> 
                            </div>
                            <div class="ipad_words_even object">
                                <h1>スプレッドシートを編集したり、Keynoteでプレゼンを仕上げたり、ノートを美しくまとめたり。Magic Keyboard Folioなら思いのままです。快適にタイピングできるキーボードも、正確にタスクをこなせるトラックパッドも使えます2。</h1>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="tabs__content">
                            ...
                            <div class="tabs__section">
                                <div>
                                    ...
                                    <p class="ipad_tab2_p">サイズ:  長さ 248.6 mm × 幅179.5 mm × 高さ 7 mm</p>
                                    <p class="ipad_tab2_p">重量:  477 g</p>
                                    <p class="ipad_tab2_p">色:  シルバー、ブルー、ピンク、イエロー</p>
                                    <br>
                                    <!-- <button>www</button>
